...
package dk.dk.niclas.cast.utils;
...
import dk.dk.niclas.cast.queue.QueueDataProvider;
    ...
    public static void showQueuePopup(final Context context, View view, final MediaInfo mediaInfo) {
        ...
        popup.getMenuInflater().inflate(
                provider.isQueueDetached() || provider.getCount() == 0
                        ? R.menu.cast_detached_popup_add_to_queue
                        : R.menu.cast_popup_add_to_queue, popup.getMenu());
